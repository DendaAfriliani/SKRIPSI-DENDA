...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <!-- <link rell="stylesheet" href="{{ asset('styles/material_icon.css') }}"> -->
    ...
    <script src="{{ asset('scripts/button.js')}}"></script>
  </head>
  <body class="h-100">
    ...
    <script src="{{ asset('scripts/js/jquery.min.js')}}"></script>
    <script src="{{ asset('scripts/js/popper.min.js')}}"></script>
    <script src="{{ asset('scripts/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset('scripts/js/Chart.min.js')}}"></script>
    <script src="{{ asset('scripts/js/shards.min.js')}}"></script>
    <script src="{{ asset('scripts/js/jquery.sharrre.min.js')}}"></script>
    <script src="{{ asset('scripts/extras.min.js')}}"></script>
    <script src="{{ asset('scripts/shards-dashboards.min.js')}}"></script>
    <script src="{{ asset('scripts/app/blog-overview.js')}}"></script>
  </body>
</html>